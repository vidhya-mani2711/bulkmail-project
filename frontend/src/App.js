  ...
  return (
    <div>
      ...
      <div className="bg-blue-800 text-white text-center">
        <h1 className=" font-medium px-5 py-3">We can help your businesswith sending multiple emails at once</h1>
      </div>
      ...
      <div className="bg-blue-400 flex flex-col items-center text-black px-5 py-3">
        ...
        <div className="bg-blue-300 flex flex-col item-center text-black">
